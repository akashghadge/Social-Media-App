...
const SendMail = (toMail) => {
    ...
    const body = {
        ...
        text: `This is your One Time Password. It is Valid for next 10 min\n${otp}\nThank you...`
    }
    ...
    transport.sendMail(body, async function (err, data) {
        if (err) {
            ...
            // console.log(data);
            if(data.accepted!==null) console.log(`OTP sent Successfully to ${data.accepted[0]}`);
            else console.log(`OTP is Not send an Error Occurs`);
